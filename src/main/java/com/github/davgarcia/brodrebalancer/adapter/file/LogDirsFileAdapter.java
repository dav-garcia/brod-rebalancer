...
public class LogDirsFileAdapter implements LogDirsInput<LogDirsFileAdapter.CliOptions> {
    ...
    public String getHelp() {
        return "Reads log dirs information from a JSON file generated by kafka-log-dirs.sh.";
    }
    ...
    public static class CliOptions {
        ...
        @Parameter(names = "--input-path",
                description = "Location of the JSON file generated by kafka-log-dirs.sh (required if --input file).")
